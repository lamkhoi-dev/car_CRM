# Th�nh Th?nh — Hệ thống quản lý cho thuê xe cao cấp
...
Th�nh Th?nh là hệ thống CRM cho thuê xe Full-stack, giao diện tiếng Việt, hỗ trợ dark/light mode, responsive trên mọi thiết bị. Hệ thống phục vụ khách hàng đặt xe trực tuyến và admin quản lý toàn bộ nghiệp vụ.
...
│  DB: Th�nh Th?nh│        │  Image/Video CDN │
│  7 collections│        │                  │
└──────────────┘         └─────────────────┘
```
...
**Database:** `Th�nh Th?nh` — 7 collections:
