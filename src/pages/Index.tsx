          ...
          <div className="mx-auto max-w-4xl">
            ...
            {pricingTab === 'packages' && pricingPackages.length > 0 && (
              <div className="overflow-hidden rounded-xl bg-card card-shadow">
                ...
                <div className="hidden grid-cols-7 bg-primary/5 px-6 py-3 text-[11px] font-semibold uppercase tracking-wider text-muted-foreground sm:grid">
                ...
                {pricingPackages.filter(p => p.isActive).map((pkg, i) => (
                  ...
                  >
                    {/* Desktop row */}
                    <div className="hidden grid-cols-7 items-center px-6 py-3 sm:grid">
